        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            ...
            <ul
              className={`${
                setNav
                  ? "grid gap-3 transition-all absolute shadow-lg bg-black text-white w-full py-6 px-10 left-0 right-0 top-[60px] md:flex md:gap-6 md:ml-8 text-lg"
                  : " gap-3 absolute bg-black text-white w-full py-6 px-10 left-0 right-0 top-[-1000px] md:relative md:top-0 transition-all md:flex md:gap-6 md:ml-8 text-lg"
              }`}
            >
